...
const TopDoctors = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 my-16 text-grey-900 md:mx-10">
            ...
            <button onClick={() => { navigate(`/doctors`); scrollTo(0,0)}} className="bg-blue-50 text-gray-600 px-12 py-3 rounded-lg mt-10 hover:scale-103 transition-all duration-300">More...</button>
        </div>
    );
};
