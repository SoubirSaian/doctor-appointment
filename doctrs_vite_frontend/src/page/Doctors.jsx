        ...
        <div>
             ...
             <div className="flex flex-col sm:flex-row items-start gap-4 mt-4">
                ...
                <div className="flex flex-col gap-4 text-sm text-gray-600">
                    ...
                    <p onClick={()=> speciality === 'Dermatologist' ? navigate('/doctors') : navigate('/doctors/Dermatologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Dermatogist" ? 'bg-indigo-100 text-black' : ''}`}>Dermatologist</p>
